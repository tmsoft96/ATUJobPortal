class Dictionary:
    ...
    workTypeList = ["Contract", "Full Time",
                    "Intenship & Graduate", "Part Time"]

    jobLevelList = ["Graduate trainee", "Volunteer, internship",
                    "Entry level", "Mid level", "Senior level", "Management level", "Executive level", "No Experience"]

    languageList = ["English", "Chinese", "Hindi", "Spanish", "French", "Arabic", "Bangla/Bengali", "Russian", "Portuguese", "Indonesian", "German", "Akan (Fante, Asante Twi and Akuapem Twi)",
                    "Akposo", "Ewe", "Dagbani", "Dangme", "Dagaare", "Ga", "Nzema", "Kasem", "Gonja"]
